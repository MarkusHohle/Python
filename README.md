...
from BayesianSignalDetect import * &emsp <br/>
T = CreateSignal(N = 5000, w = 0.1, noiseratio = 0.5)&emsp #creates ToA (T) and creates plot of binned light curve <br/>
FFT(T)                                               &emsp #FFT barely, if at all, finds w. <br/> 
S = SignalDetect(T)<br/> 
[Omega, P] = S.FindFrequency()                        &emsp#should give you a nice periodogram after 40s <br/>											
